...
class AppData {
  ...
  static List<RecommendedProduct> recommendedProducts = [
    RecommendedProduct(
      imagePath: "",
      cardBackgroundColor: const Color(0xffd7d54f),
    ),
    RecommendedProduct(
      imagePath: "",
      cardBackgroundColor: const Color(0xff3d8a55),
    ),
    RecommendedProduct(
      imagePath: "",
      cardBackgroundColor: const Color(0xff53aed3),
    ),
    RecommendedProduct(
      imagePath: "",
      cardBackgroundColor: const Color(0xff9362b9),
    ),
    RecommendedProduct(
      imagePath: "",
      cardBackgroundColor: const Color(0xff4c6955),
    ),
  ];
}
