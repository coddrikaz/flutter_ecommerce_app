                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        icon: const Icon(Icons.add, color: Color(0xff0183bb)),
                      ),
                    ],
                  ),
                )
    ...
    return SizedBox(
      ...
      child: Padding(
        ...
        child: ElevatedButton(
          style: ElevatedButton.styleFrom(padding: const EdgeInsets.all(20) , primary: Color(0xff0183bb)),
